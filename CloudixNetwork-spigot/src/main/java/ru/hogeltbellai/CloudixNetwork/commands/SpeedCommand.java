...
public class SpeedCommand extends BaseCommand {
    ...
    protected boolean executeCommand(CommandSender sender, String label, String[] args) {
        ...
        if (args.length == 0) {
            U.msg(sender, T.error("&#08FB36&lCLOUDIX","Используйте - /" + label + " [скорость ходьбы/полёта]"));
            return true;
        }
        ...
        try {
            ...
            U.msg(sender, T.system("&#08FB36&lCLOUDIX", "Аргумент должен быть числом от 1 до 10"));
            return false;
        }
        ...
        if (player.isFlying()) {
            ...
            U.msg(sender, T.success("&#08FB36&lCLOUDIX", "Скорость полёта установлена на: " + speed));
        } else {
            player.setWalkSpeed(0.2F + 0.08F * (speed - 1));
            U.msg(sender, T.success("&#08FB36&lCLOUDIX", "Скорость ходьбы установлена на: " + speed));
        }
